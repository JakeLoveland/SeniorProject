...
class WantViewController: UIViewController {
    ...
    let popup : Popup = Popup(section: "want")
    ...
    extension WantViewController: UICollectionViewDataSource {
        ...
        func collectionView(_ collectionView: UICollectionView,
            ...
            return UserModel.user.shows["want"]!.count
        }

        func collectionView(_ collectionView: UICollectionView,
                            cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: ProfileCollectionViewCell.identifier, for: indexPath) as! ProfileCollectionViewCell
            let show = UserModel.user.shows["want"]![indexPath.item]
    ...
    extension WantViewController: UICollectionViewDelegate {
        ...
        func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
            if popup.window == nil {
                popup.display(show: UserModel.user.shows["want"]![indexPath.row])
